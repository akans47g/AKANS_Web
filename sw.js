...
const STATIC_ASSETS = [
  ...
  BASE + 'admin-bookings.html',
  BASE + 'admin-templates.html',
  BASE + 'admin-reviews.html',
  BASE + 'admin-coupons.html',
  BASE + 'admin-users.html',
  BASE + 'admin-referrals.html',
  BASE + 'admin-settings.html',
  BASE + 'admin-whatsapp.html',
